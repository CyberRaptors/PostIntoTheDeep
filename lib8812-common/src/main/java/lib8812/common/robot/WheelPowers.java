...
public class WheelPowers {
    ...
    public void applyTo(IMecanumRobot bot) {
    ...
    public void applyTo(IMecanumRobot bot, WheelPowers weightage) {
        morph(weightage).applyTo(bot);
    }

    public void applyTo(IMecanumRobot bot, Function<Double, Double> simpleFineTuner) {
        morph(simpleFineTuner).applyTo(bot);
    }

    public void applyTo(IMecanumRobot bot, WheelPowers weightage, Function<Double, Double> simpleFineTuner) {
