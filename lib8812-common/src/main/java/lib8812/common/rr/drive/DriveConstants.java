...
public class DriveConstants {
    ...
    public static final double MAX_RPM = 0; // TODO: CHECK & FIX
     ...
     */
    public static double WHEEL_RADIUS = 1.88976; // in, exact from website, but still CHECK
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 0; // TODO: ADD
    ...
    public static double MAX_ANG_VEL = 2.99;
    public static double MAX_ANG_ACCEL = 2.99; //Math.toRadians(184.02607784577722);
